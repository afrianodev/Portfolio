//Data to provide the portfolio works
...
const portfolioInfo = [
    {
        ...
        techs: 'React, Vite, REST API, Tailwind CSS, Framer Motion, Vercel',
        github: 'https://github.com/afrianodev/balancebites'
    },
    {
        w_img : '/casita-horror.webp',
        w_name: 'Casita del Horror',
        w_url: 'https://casita-horror.vercel.app/',
        description: 'A horror movie streaming platform with full-length films and immersive dark UI. Users can explore, stream, and enjoy complete scary content from a CDN.',
        techs: 'React, Tailwind CSS, Vite, Vercel, Render, Node.js, Express, MongoDB, HTTP requests, CDN',
    ...
    },
    {
        ...
        techs: 'React, Tailwind CSS, Vite, Vercel, Render, Node.js, Express, MongoDB, HTTP requests, CDN',
        github: 'https://github.com/afrianodev/treehouseHorror'
    },
    {
